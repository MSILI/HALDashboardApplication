				...
				<table id="tableau"
					...
					<tbody>
						<c:forEach items="${listEquipes}" var="equipe" varStatus="boucle">
							<tr>
								<td><c:out value="${equipe.idHal}" /></td>
								<td><c:out value="${equipe.acronyme}" /></td>
								<td><c:out value="${equipe.nom}" /></td>
								<td><a
									href='<c:url value= "/gestionEquipe?action=edit"><c:param name="id" value="${equipe.id}"/></c:url>'><span
										class="glyphicon glyphicon-pencil"></span></a></td>
								<td><a
									data-confirm="Etes-vous certain de vouloir supprimer?"
									href='<c:url value= "/gestionEquipe?action=delete"><c:param name="id" value="${equipe.id}"/></c:url>'><span

...
<body>
	...
	<div class="row">
		<div class="container">
			...
			<form id="form" action='<c:url value="/compte?action=insc"/>'
				method="post">
				<div class="col-md-6">
				...
				<div class="col-md-6">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3>Informations Laboratoire</h3>
						</div>
						<div class="panel-body">
							<div class="form-group">
								<label>ID HAL Labo : </label> <input type="text" name="idHaLabo"
									value=""
									class="form-control validate[required,minSize[4],custom[integer]] text-input" />
							</div>
							<div class="form-group">
								<label>Nom Labo : </label> <input type="text" name="nomLab"
									value=""
									class="form-control validate[required,minSize[3]] text-input" />
							</div>
							<div class="form-group">
								<label>Acronyme Labo : </label> <input type="text"
									name="acronymeLab" value=""
									class="form-control validate[required,minSize[3]] text-input" />
							</div>
						</div>
					</div>
